...
export const ActionBanner: React.FC = () => {
  return (
    <section className="mt-8">
      <div className="relative bg-surface rounded-3xl p-6 flex items-center justify-between min-h-[100px] overflow-hidden border border-white/5 group cursor-pointer hover:border-primary/30 transition-colors">
